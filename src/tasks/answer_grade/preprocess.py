...
def preprocess(arguments):
    ...
    craw_corpus_qa = arguments['tasks'][running_task]['dataset']['corpus_qa']
    file_train_q = arguments['tasks'][running_task]['dataset']['train_q']
    file_train_a = arguments['tasks'][running_task]['dataset']['train_a']
    file_test_q = arguments['tasks'][running_task]['dataset']['test_q']
    file_test_a = arguments['tasks'][running_task]['dataset']['test_a']
    ...
    craw_data = pandas.read_csv(project_root + os.path.sep + craw_corpus_qa, encoding='utf-8')
    ...
    print("saving...")
    put_txt_to_file(train_q, project_root + os.path.sep + file_train_q)
    put_txt_to_file(train_a, project_root + os.path.sep + file_train_a)
    put_txt_to_file(test_q, project_root + os.path.sep + file_test_q)
    put_txt_to_file(test_a, project_root + os.path.sep + file_test_a)
